...
public class BellmanFord2 {
	...
	void BellmanFord_(BellmanFord2 bf, int src) {
		int V = bf.V, E = bf.E;
		int dist[] = new int[V];
		for (int i = 0; i < V; ++i) {
	...
	public static void main(String[] args) {
		...
		FileReader fr;
		try {
			fr = new FileReader("C:\\Users\\micke\\eclipse-workspace\\ALG\\src\\data11_bellman_ford_2.txt");
			...
			int[] start_point = new int[5];
			int[] end_point = new int[5];
			...
			int V = 3, E = 4;
			BellmanFord2 bf = new BellmanFord2(V, E);
			for (int i = 0; i < E; i++) {
